...
namespace Repository.Migrations
{
    ...
    [Migration("20231208022745_UpdateRequest-Booking-DayTime-Appointment-Relations")]
    partial class UpdateRequestBookingDayTimeAppointmentRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.Booking", b =>
                {
                    ...
                    b.HasOne("Core.Models.Request", "Request")
                        .WithOne("Booking")
                        .HasForeignKey("Core.Models.Booking", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.DayTime", "Time")
                        .WithOne("Booking")
                        .HasForeignKey("Core.Models.Booking", "TimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
